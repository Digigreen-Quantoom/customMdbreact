...
exports["default"] = exports.MDBAlert = void 0;
...
var Alert = exports.MDBAlert = /*#__PURE__*/function (_Component) {
  function Alert() {
    var _this;
    ...
    _defineProperty(_this, "closeAlert", function () {
      _this.setState({
        isOpen: false
      });
    });
    _defineProperty(_this, "handleOnExit", function (node) {
  ...
  return _createClass(Alert, [{
    ...
    value: function render() {
      ...
      var alertClasses = (0, _classnames["default"])("alert", color && "alert-".concat(color), className);
      var alertComponent;
      if (dismiss) {
        alertComponent = /*#__PURE__*/_react["default"].createElement(_reactTransitionGroup.Transition, {
        ...
        alertComponent = /*#__PURE__*/_react["default"].createElement("div", {
          className: alertClasses,
          role: "alert"
        }, children);
      }
