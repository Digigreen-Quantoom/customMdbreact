...
exports["default"] = exports.MDBChip = void 0;
...
var _excluded = ["className", "tag", "size", "bgColor", "text", "gradient", "src", "alt", "close", "waves", "handleClose"];
...
var Chip = exports.MDBChip = /*#__PURE__*/function (_Component) {
  function Chip(props) {
    var _this;
  ...
  return _createClass(Chip, [{
    ...
    value: function render() {
      ...
      var classes = (0, _classnames["default"])("chip", size && "chip-" + size, bgColor && bgColor, text && text + "-text", gradient && gradient + "-gradient", waves && "Ripple-parent", className);
      return /*#__PURE__*/_react["default"].createElement(Tag, _extends({}, attributes, {
        ...
        src: src,
        alt: alt
      }), this.props.children, waves && /*#__PURE__*/_react["default"].createElement(_Waves["default"], {
        cursorPos: this.state.cursorPos
      }), close && /*#__PURE__*/_react["default"].createElement(_Fa["default"], {
        icon: "times",
        className: "close",
