...
exports["default"] = exports.MDBAnimation = void 0;
var _react = _interopRequireWildcard(require("react"));
var _propTypes = _interopRequireDefault(require("prop-types"));
var _classnames = _interopRequireDefault(require("classnames"));
var _excluded = ["className", "tag", "type", "duration", "delay", "count", "reveal", "infinite", "style", "children"];
...
var Animation = exports.MDBAnimation = /*#__PURE__*/function (_Component) {
  function Animation(props) {
    ...
    _defineProperty(_this, "handleStart", function (e) {
      _this.setState({
    ...
    _defineProperty(_this, "handleIteration", function (e) {
    ...
    _defineProperty(_this, "handleEnd", function (e) {
      _this.setState({
        countIterations: _this.state.countIterations + 1
      });
    ...
    // helper fx
    _defineProperty(_this, "getOffset", function (elem) {
    ...
    _this.elemRef = /*#__PURE__*/_react["default"].createRef();
    return _this;
  }
  ...
  return _createClass(Animation, [{
    ...
    value: function render() {
      ...
      var classes = (0, _classnames["default"])(this.state.isVisible && "animated",
      // will this work?
